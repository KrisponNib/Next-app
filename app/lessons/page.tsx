        ...
        <section className="first wrap section">
          ...
          <div className="section-grid">
            ...
            <div className="body-copy">
              ...
              <p>ולפני שתשימו לב, כבר נקליט שיר ראשון להשמיע למשפחה ולחברים :)</p>
          ...
          <div className="wrap">
            <div className="section-grid">
              ...
              <div className="body-copy">
                ...
                <p>
                  והכי כיף - הכול מחובר ומוכן להקלטה מסיימים לעבוד על שיר, מקליטים אתכם,
          ...
          <div className="section-grid">
            <div>
              ...
              <p className="about-note">
                אני מתופף כבר 11 שנה, ועדיין מתרגש מתופים בצורה קצת מוגזמת
              </p>
            </div>
            <div className="body-copy">
              <p>
              ...
              <p>
                אני רוצה שתצאו מהשיעורים שלי עם יותר מוזיקה בחיים שתשמעו שירים אחרת,
